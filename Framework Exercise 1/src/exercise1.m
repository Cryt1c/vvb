function exercise1()
    ...
    [bok,scribble_count, fg_scribbles, histo_fg, histo_bg] = get_histograms(input_directory, file_list, 255);
    ...
    for j = 1:(numel(file_list))
        ...
        if (((mod(count, loop_size)) == 0) || (j==(numel(file_list)-3)))
            ...
            foreground_Map = segmentation(frames(:,:,:,count), fg_scribbles, histo_fg, histo_bg, 256);
            % store frames
